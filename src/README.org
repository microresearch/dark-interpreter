...
- how to test datagen walker? (should hw also be all nextdatagen or stick with walkers?)DONE
- mirrormods testedDONE ===> filled in for all casesDONE-to TEST!

TUE 25:
- nearly all HW as all nextdatagens and lose walkers???
- maybe do away with global datagen runnings and that mode and run all as are?
