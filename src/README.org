...
3-modifier (4) - eg. speed, re-inits, add to stack, memory exchange,
cpu-swap factor, samplerate, leakiness, mutation rate, sample effects,
digital filter effects, granular or not, step through datagen buffer,
datagen-to-clocks, chaining of datagens (new stack) ... or most as in
1 above // here focus on speed/samplerate/step 
...
+ steps/path through datagen counter/dir // hardwareswitch into
  datagen // filterops into datagen and clocks into datagen
...
- how we access datagen in hardwareswitch 
