...
- TESTS:test effects, test new wormdir, test new mode code, TEST mirror/setting mode code

TODO:
- need set foldback settings in mainmode (replace or simply add in)
- third ATTACH knob is underused (should always be attached)// added into mirror code

/////

- redo IFDEFs last, possibly also settings.h as IFDEFed for LACH!!!
