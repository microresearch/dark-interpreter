...
- MON/TUE:finish simulations(rossler,orbital, ifs), SIR and hodge.


3 sorts of datagen: CPUs, float-style simulations, cellular
automata...

all of which are writing across 64k buffer space which grain
parameters can move in directions across and also exchange with
