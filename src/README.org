...
- test CAforstack.cDONE and FIXED

NOW: 

- why datagens sound like noise, is adc9 working and how to test?

- is question of delays?

- all stack adds should set delay and howmuch (also accessible)

TODO:

5-test all datagen/hardware flags with simple datagen running 

6-test clocks and unhanging?->needs code to finish it//all TODO code

7-[construct/test simple board]

8-hard tests on all hard-specific

9-wrap all code/cleanup

* WED 5 MAR

TODO: 

- test cpu, pureleak, CA == all datagens
