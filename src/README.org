...
exchange,samplerate, leakiness, mutation rate, sample effects, granular or not
...
how micro-macro knobs works with this and how we add/subtract to cpu stack...
...
- 16 bit math ops in cpuint??, and what about stepping - step through databuffer...
