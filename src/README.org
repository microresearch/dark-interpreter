...
- check 5th adc buffer
- test hardware
- check bits for audio.c EFFECTREAD, WRITE, FILT and in main.c!
- test 40106 voltages and code
- where is annoying high-pitch from?

TODO:

- foldback onto foldback!
- foldback TEST // FULL TESTS, isolated tests...
...
- fix 16 bit settings of settingsarray DONEbut not TESTED!
- stack/knob/foldback code TO TEST
