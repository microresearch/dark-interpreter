...
TUE 25:
- all HW except main one as all nextdatagens and lose walkers???
- finish case 15 mirrorsDONE

- finish swap case 14 as all infects/fingers in the code
- fill out rest of TODOs
- fill in extra/new effects and test
- re-order modes

WED/THU/FRI 26:
- re-test each section datagen//r/w/filt//effects//mirrors/hw
- sampling speed and final tests, TODO and tweaks/speedups/sanity checks 
= ifdefs for LACH
...
= round up size of structs,inlining,less local vars in function, pass
  ...
  of full words(32 bytes) not bytes, sanify loops
...
- testing and finished mirror - to test in FULL
...
- ordering of modes - first should be HW
