...
- where we do stack push/pulls and the appropriate settings?TEST so far....

- master foldbacksettingwalker is set where?as extra setting-past end of settings TEST

//////

- finger setting - up/down, direction
