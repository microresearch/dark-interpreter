...
- tune/check spd and all speeds
- more use of knobs in modes
- check digital filter effects
- how to buffer generations of setting infction in mode 14?
- TEST now wrapped all hardware in HWSPEED

- TEST new worm changes in audio.c and also changes to order

- somehow a new first mode which describes (by hand) an arrangement or
  reduction of modes!!! how exactly: hand walker of walkers
- re-check _all_ files: main.c*DONE, audio.c, sim, ca, pureleak, CPU
