...
- shifted machine_count wrapperTEST

- test hardware all cases and speeds
- look at samplespeed
- test 40106 voltages and code
- where is high-pitch from in effects
...
PLAN:
T/W/THU/test basic brds/tweak/record/document/build more!!
