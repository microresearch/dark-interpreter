...
- all tests below //full test crashes so isolate

[marking test settings as TESTER]

- what if steps are zero??? what else should not be zero. trap this

- also fullfinger setting up and down

- differences for full/lower fingers?
