...
- re-test each section: *datagenTEST//datagenwalkerSANITY//r/w/filt//effectsSANITYTEST//mirrors//hwTESTED*

- finish swap case 13 as all infects/14-fingers in the code
- list and complete rest of TODOs eg. speed and step for effects
- re-order modes---first/last mode as always HW
