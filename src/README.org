...
- audio.c sample wrap size/constraint=grainsize as part of speed
  setting or complexity

////

- new hardware settings:

that main.c hardware dir can also be wormdir>hardware option? as flag?
...
of stack/push/pull as knob] -> somewhere else
