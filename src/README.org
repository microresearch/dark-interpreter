...
- finish mirror and running mirrors//-TO TEST!
- finish attach==settingsarrayattached////-TO TEST!

- SEE TUE/WED TODO: hardware walkers, villagers
- villagers: how many can we have?, start/wrap/effect
...
- swaps can be in mirror on finger left/right#
