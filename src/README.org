...
- to recap what needs to be done... crashtests/new ideas/formant?

TODO:

- do granulations make sense/sound okay?
- steps in CA and simulation
- swopping between audio and data buffers (in stacks?)
- mirror/settings and new settings
- fill out complexity settings
- filter effects and mirroring
...
mirror one set of settings to other half (or add or subtract, or multiply)

mirror and stacks!

so we have top=mirror/darkint

1-hardware 5-filterops
2-leadingedge 6-topedge - and/or set who that edge is for?
...
//8-operations on settingsarray (walker, mirrors, viral etc.)
...
write left into audiobuffer or datagenbuffer, playback from place in audiobuffer
