...
- test all effects with simple audio I/O (see below):
...
4. basic working model with overlap/compression/left-filter/HW/datagens/mirrors
...
-villagers and compression->in process compression-TEST

///TODO:
-do datagen compression anew
