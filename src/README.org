...
- what has changed in WORM code to port here: effect.c and vocoders,
  new generators, klatt and phonemes, etc....

- seems like  we just use buf16?

- how have modes changed?
