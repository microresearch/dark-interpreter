...
- check main.c in master branch: howmuch for sim and CA are high// FIX?
- how and where effects between write-villagers are timed
- villager overlays/readbit should be per villager ideally

- porting sim now as simforstacksansmem2.c - TODO pull into main and
  protos in sim.h

porting remaining CPUs as datagen walkers: pureleak with restraints on
pokee and peekee from start and end
...
- some effects as buf16 code (eg. impulses, convolution, envelope detection/reduction)
- mirror in villagers as pointer to villagers
- HW hangings in overlap scheme? how?
- R/W and expands for leftread/leftwrite
- modulus as effect
- walker for datagens supersedes stack code
