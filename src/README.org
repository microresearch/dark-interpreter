...
- re-test timeslice vs. no slice!

- where to set LMERTWO? (as HW=hdgener/lmer/lmertwo/40106/maxim=5)
- re-test mode 4 with LACH
- re-test speeds and modes on TENE

- what is not set in TENE/SUSP is:

anystarts//anywraps//anysteps=9 settings

- test SUSP (as same but knobs differ)
- manual///documentation///website

** DONE

- timeslices must be static u8 i!
