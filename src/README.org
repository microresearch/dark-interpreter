...
- modulus as effect in both master/TEST and towers
- overlaps as selected= and, or, mod, *, +, none
- do we insert dategen/buf16 there in readin????

** DONE

- got rid of straight in/out as is same as overlap/no with 1 villager,
only one read and write mdoe

- sanity test of villagers (vaguely in test.c checks out!)
- changed loop for sample update - to TEST!
