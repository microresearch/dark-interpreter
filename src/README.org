...
- sanity check all again - main, audioX, effect, sim, ca, pureleak, cpu

esp. bits/sizes/sanityingeneral!

- to step or not in audio.c and main.c (hardware and datagen)
- test LACH(48k???) [+ SUSP should be as TENE but test when ordered!]

- re-test full 
- re-test each section/mode: datagen//datagenwalker//r/w/filt//effects//mirrors//hw

//////////////////////////////////////////////////////////////////////
- manual update/web pages//price drop=130/210/260//announce and advertise//ebay/etsy
- also for LACH sever out pad connection [under power conn], replacement 10uFs on incoming!!!
...
else dirry=dir[village_maxim[x].dir]*village_maxim[x].speed;
