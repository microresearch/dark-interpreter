...
- fix mirror transitions so is not gap round mirrored setting
- fix 16 bit settings of settingsarrayDONE-almost?TEST
...
PLAN:
FRI-finish basics
MON-THU /test basic brds/tweak/record/document/build
