...
what groups we mirror?: readin, filtout, effect,datagenwalker and
HW and what parts of struct are mirrored? eg.  overlay in read, modifier in effects
...
- mirrormods testedDONE ===> filled in for all cases
...
WED 26:
- sampling speed and final tests, TODO and tweaks
