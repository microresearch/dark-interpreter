...
4 phase: knobs assigned and all tests/RELEASE
...
- work schedule/plan for end January release:

1week: datagens/test hardware (by begin JAN)
2week: buffers/grains
3week: knobs and tweaking
* THU 26 DEC
...
malbolge: converts all of memory first for interpreter?
befunge: possible... http://en.wikipedia.org/wiki/Befunge
stack1: http://www.ece.cmu.edu/~koopman/stack_computers/sec3_2.html#321

- stack conversions for some of CPUs in leaky.c
