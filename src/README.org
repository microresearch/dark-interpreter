...
- test new hardware optionsDONE-example code for digfilterbackDONE-TEST!

- execution stack for datagensDONE-TEST!

- test new speed settings+ granulationDONE-TEST!

- handling edger via complexity- as set of options/walkersDONE-TEST!
