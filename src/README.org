...
1-mainmode=x8 || x8 // mirror/attach(using finger UP/DOWN)->mirror edge(LEFT/RIGHT as extent)
2-knob for mainmode/mirror edge 
3-action/agent? OR pull speeds out of settings?but how different each speed?
4-attached knob
5-HW//EFFECTWRITE in LACHS
