...
TODO:
- test with 9v 200mA PSU-to get!
- FORMANT does not work with floats (only in test.c with doubles)REDO!
...
- test SUSP (first with audio.c effects) - re-check hardware and 40106 voltage
