...
[1day]WED
- simplify read/write in audio.c 
*- test updates/tweaks in audio.c*
- start and wrap code all datagens
- re-test all audio/datagens and audio!

[2days]THU
- assign/map new knobs and all settings re-arranged (all new ideas into files)
...
[extras]WED+
- excess settings settings - actions such as read/write mirror which are like one off operations
