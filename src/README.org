...
- add power socketDONE and check if can do simplified audio route for v
  basic D.I (can be done with additional jumpers) DONE

PCB CHECKLIST:

- new track widths for all audio/adc 0.5mm
- look where we have xtal,pwm and I2S signals crossing audio/adc
