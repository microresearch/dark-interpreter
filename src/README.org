...
- modded howlook so datagens are longer as per voice branch

* MON JUL 20

- collapsed ifdef for mainmodes so NO duplication and no need to keep
  porting changes! TO TEST!

TODO: 
- make same changes in VOICE! though is commented out now
- collapse all switches in audio.c mode and new mainmode ideas, grid of pointers
- KLATT etc. research
