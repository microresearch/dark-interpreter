...
///FRI:
- tweaks/re-test ALL (speeds in particular)
- test LACH and SUSP (first with audio.c effects)
- test with other fingers
- test with battery and PSU(find)
- recordings/video/manual/website

** DONE

- re-test all functions in sim: put vars and inits INTO functions
