...
TODO:
- if certain knobs are 0 then don't change values (start.wrap.effects)
- try BUFF_LEN as 16 for better granularity (of HW)...
- how see how much memory is left with debugger?
- logarithmic scaling for start/wrap HOWTO?
...
DONE:
- removed all villager/settingsarray refs
- basic new RW walkers -> TODO: test audio.c
...
4- simple formant filtering (above)
...
following: http://kernelhacks.blogspot.de/2013/01/cmsis-dsp-software-library.html
