...
web pages//price drop//announce and advertise//ebay/etsy/

- full test and recordings DONE but need now to test each mode individually!

- sanity checks:

sanity: audio, effects, sim, ca, leak, cpu, main

- ifdefs for LACH-DONE and test LACH/SUSP (to build)
