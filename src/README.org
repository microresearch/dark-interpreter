...
- TESTtry to push/pop poti on all stacks!NEW CODE

- add push/pop for finger code TEST

- TESTtry settingsfinalfoldback!

- finger code for lower board and test THERE

/////

- crash potentials WHY??? in edger?

- also fullfinger setting up and down/left-right_WHERE TO SET on zero
  of top knob (and shift array)

- constraints in each file for all settings main.c audio.c
