...
- question of villager metaphor/approach/past texts?

- playing with cons as % or >> in audio.c
...
- test all datagens and stack approach
- swopping between audio and data buffers (can be done in stacks or as general setting?)
- knobs-mirror/settings and new settings
- fingers
- fill out extra complexity settings
