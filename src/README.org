...
and pureleak: lots of fixes,

- what was slowdown in mutate etc/cpurev?

5-test all datagen/hardware flags with datagen running
...
[8-hard tests on all hard-specific????9-wrap all code/cleanup]
