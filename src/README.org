...
- re-test villager effects with corrected code
- new layout below
...
- are stack/cpu settings always constrained %32768 etc. or do we need to?
...
- per villager effects TO TEST
- wormdir and fingerdir also (put in one of finger modes)
- different hardware walkers

???> depending on new modes:
