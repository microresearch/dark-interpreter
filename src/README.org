...
what groups we mirror?: readin/out, filtout and HWs. and what parts of struct are mirrored? eg.  *also mirror overlay* in read

TODO 19NOV: re-test mdavocoder, fill out all effects
...
- filling out effects: all to be tested esp. new convolution
