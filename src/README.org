...
effects earlier notes combined. to test now but all effects will be
across villagers// size question?

now mostly in docs...

1-CONV/2-phase vocoder/3-bandpass vocoder/4-FFT spectral exchanges/5-simple formant vowels
...
http://forum.arduino.cc/index.php?PHPSESSID=p65dcijap55ekhnm8no9h6s3b3&topic=224227.30

simulation of VOSIM in sc3-plugins, formant ugens: http://gurzil.livejournal.com/15375.html

SC synthdef for vowels with BBandPass : http://sccode.org/1-4Vk and
...
OWL: http://www.muffwiggler.com/forum/viewtopic.php?p=1495970
