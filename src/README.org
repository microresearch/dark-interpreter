...
=overlapsDONE/leftwalkersDONE/HW walkersTEST_TUE4NOV/(datagen walker)TEST = mirrors/infectionSTARTED 5NOV// effects and effect walker finally-close4NOV

NOTE//WED 5: OPEN FIRE: mirrors and datagenmirrors//effects//tests of HW
...
- decide how mirror villagers work (is it just for offset.start and wrap and how and where mirrors modulate?)

TO RESOLVE: effects processing-nearlyDONE//, datagen walkerformirror-delivery, mirroring as trickiest

TEST: HW walkers, basics of first mirroring, basics of effect walker

/////
mirror struct:// where this is written to modify start and ends?
...
- speeds and step still to do in effects walker
...
- defines for HW versionings or seperate makefiles= what are difference TENE?SUSP (in HW) so can also have 2 makefiles just for 1/LACH or 2/SUSP+TENE
