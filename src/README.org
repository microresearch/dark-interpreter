...
- flatten stacks and villager to single arraysDONE-to test///and fixed problems in CA and sim!
- re-arrange settings to change easily increment for fingersDONE-TEST!
- test 40106 if leaks and run continuous if not leaky
- stacks and villager as stack handling
...
PLAN:
FRI-finish basics
MON++ /test basic brds/tweak/record/document/manual 
