...
need to rethink how filterin/out works as too complex comment for
moment and test.. even now constrained to 16k

new scheme: readin and filterin as in, out and filterout as simple
model of single villager start, wrap and constrain (without mirror) as
also overlap makes no sense there... also possibly inc. filterin into
readin as option
...
- how we can speed up audio.c and villager overlap processing???
