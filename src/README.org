...
0-hardware(2) (and for Lachrymarum? - repeat up/down of 4finger-mod?)
...
exchange, cpu-swap, samplerate, leakiness, mutation rate, sample effects,
digital filter effects, granular or not, step through datagen
buffer... or most as in 1 above // here focus on speed/step
