...
- overlap and uint16 sizes for CPU.c
- other TODOs from each file (eg. delay in simulation.c)
- cleanups/fix adc code

then start on buffer/grain code, hardware tie-ins and ADCs
