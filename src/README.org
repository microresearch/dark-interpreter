...
- audio.c + or - 32768 between buf16 and audio_buffer - BACKUP/TEST!

- should we use UP/DOWN for foldd[1] in cases 26+
- tweaks/re-test ALL

- IFDEFs last(hardware knob replaced with EFFECTREAD), also
...
- re-test all functions in sim

** DONE

- fixed ++ mismatches in audio.c for ldst rdst++
