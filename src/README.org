...
out and filterout as simple model of single villager start, wrap and
constrain (without mirror) as also overlap makes no sense
there... also possibly inc. filterin into readin as option//how????

*or outs as set of consecutive villagers*

or calculate villager samplepos outside audio loop but that makes no sense
