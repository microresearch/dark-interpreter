...
** ideas for next release/this release maybe?

- *somehow to define complexity in that first mode! last mode as always HW*
- sans modes or 8 modes//that there are no modes=a village//HW as one mode with fingers only?
...
- test basics of new readin/out and filtin/outDONE

- effects filled inDONE/test-FFT crashesFIXED-DONE
- how to test datagen walker?DONE (should hw also be all nextdatagen or stick with walkers?)
- mirrormods testedDONE ===> filled in for all casesDONE-to TEST
- maybe do away with global datagen runnings and that mode and run all as are?DONE

WED 26:

- *re-order modes// new idea of modes with first as selecting interface*
- finish swap case 14 as all infects/fingers in the code
- list and complete rest of TODOs:
- decide on: all HW except main one as all nextdatagens and lose walkers???

THU/FRI 26/27 and next week:
- re-test each section datagen//r/w/filt//effectsSANITYTEST//mirrors//hwTESTED
- sampling speed and final tests, TODO and tweaks/sanity checks 
- ifdefs for LACH
...
- ordering of modes - last should be HW
