...
PLAN:
MON-basics/T/W/THU/test basic brds/tweak/record/document/build

** DONE

- somewhere we lose audio in settingsarray! - try to find problem- was
  in SPEED settings to restrict
...
- re-arrange settings to change easily increment for fingersDONE-TEST!
