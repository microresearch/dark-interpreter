...
- effects test and fillout
- extra modes in main.c: 20- fingers in the code 21- infection across (how?)

/////WED:

- try maybe move all mainmode sets into main... what would this mean???? and/or what happens withj interrupt in fingerdir?
- specify effects: vocoder/spectral=FFT/genericfilters/vowelcascadeBPFs/envelope&windows/morph&loop/convolution
- effects cleaned up/init all effect structures, filter banks
- swop and copy somehow confusing - bit clearer now! but needs be filled out
