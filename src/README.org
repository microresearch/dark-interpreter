...
- last mirroraction 31 as somehow INFECTION
...
- per villager effects to test (in write now) TO TEST/EXPAND
...
- wormdir - how we can toggle use of this and if makes sense?
