...
new ideas:
- adc9 -> datagenbuffer
- simplify direction and wormcode 1, -1
- speed also on second effects knob
- setting by hands/setted by hand (last two knobs can also be setted and setting)

- also bare finger entry into settings...

1-mirror
2-hardware/effects/speed
3-push/pull
4-finger->what to set, knob sets//foldback
5-what to set//foldback settings
...
- fix mirror transitions so is not gap round mirrored settingDONE- TEST
- fix 16 bit settings of settingsarrayDONE-TEST

- stacks and villager also as stack handling
- push simultaneous stack and villager (or not)

- finish knobs and ops as below
- check all TESTYs and TESTERs, cleanups, tests

PLAN:
MON-basics/T/W/THU/test basic brds/tweak/record/document/build more!!
