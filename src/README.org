...
- for future/next release a general settings/mirror walker who walks through villagers and settings

** General TODO: 

TODO is effects walker, test datagen walker(HOW?), mirrors/infections
and fill out all templates and TEST ALL!

what groups we mirror?: readin/out, filtout and HWs. and what parts of struct are mirrored? eg.  *also to mirror overlay* in read

- test basics of new readin/out and filtin/outDONE

- effects filled inDONE/test-FFT crashesFIXED-DONE
- how to test datagen walker? (should hw also be all nextdatagen or stick with walkers)
////
- mirrormods tested and filled in
- extra fingers/modes and fill out rest of TODOs
- fill in extra/new effects and test
- sampling speed and final TODO/tweaks.
