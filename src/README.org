...
3- *band vocoder: maybe port mdaVocoder.cpp*

- how do we swap bands in our vocode.c TEST!

- see also mdaTalkBox.cpp!

4- *envelope/windowing/hanning* - see also window.c
...
- can't seem get mdaVocoder work though very briefly some results????
