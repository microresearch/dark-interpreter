...
- how do we swap bands in our vocode.c and mda TODO/ TEST!

- port also mdaTalkBox.cpp!

4- *envelope/windowing/hanning* - see also window.c and window in mdavocal.c

5- *envelope detection - how to test?*
...
- as vocoder input/processor/possible envelope see mdavoc.c
- mdaVocoder works when set 0.0 all filter array f[x][x] (is init in C++ as zero?)
