...
- where we do stack push/pulls and the appropriate settings?

- how we handle array settings and direction settings

2,0,3,4(is really higher),1 /hardware/speed/complexity/X/Y
...
+  wormdir setting for all walkers as part of struct wormflag!
...
should have speedwrappers for cpu and leak also
