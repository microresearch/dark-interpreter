...
send by 15th->pcbcartDONEawait PCBs

1 phase: hardware switchingsDONE + architecture outline 
2 phase: datagens
...
- stacks for grains/villagers and for CPUS, mix, merge, leak each other
- do we need 65,535/whatever wrap in cpus - machine peek and poke?
- cpu stacks in ccmdata
