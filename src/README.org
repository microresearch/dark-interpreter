...
- now stack run works so chances are malloc, 

* MON 24 FEB+

- see 17 feb - all hardware specific tests this week
...
2- malloc and free: SEEMS okay, but only lite tests
