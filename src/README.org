...
- further debug notes to try THU:
...
or expansion-compression is where effects would be and effects was supposed to be!

effects as seperate walker now operating on aduio/datagen buffers?

but what of hardware walkers where we need effects as specified! figure oiut
