...
what we mirror: readin/out, filtin/out and HWs???

- filtin/out handling and digfilter flag! = where we do FILTIN???extra flag that tmp is LEFTIN???

NOV18+ *also mirroroverlay* TODO!
...
- filtin is now just flag in readin overlay to be subhjected to mirroring
