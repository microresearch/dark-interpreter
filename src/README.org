...
-possible crash: optimization, stack size/overflow, memory overflow
...
- *some kind of foldback for hardware setting* settingsarray[64]//too high
...
: pureleakXmasquesTEST audioX hardwareX simulationforstackX CPUintrev3X CAforstackX
