...
DATE: 16 JUNE 2014//now17 JULY 2014

to order: opa337 for top(x3 each), 20x both pcb sets, mouser:ARM,codec,LM
...
leaves 4 tops, 4 lower(+1 basic), 4 pcbs(parts for 3)
...
OPA337UAG4  x3 -top (mouser) have 4
